...
export const de: TranslationMap = {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaLabel: "Ollama",
      ollamaHint: "Laden Sie ein tools-fähiges Modell von Ihrem Ollama-Server herunter",
    ...
    wizard: {
      ...
      prepareStarting: "Lokale Modelleinrichtung wird gestartet…",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Dieser Legacy-Browser bleibt vorübergehend verfügbar. Öffnen Sie ihn erneut über HTTPS oder localhost, um ihn mit einer Geräteidentität abzusichern.",
      pendingUnavailable:
