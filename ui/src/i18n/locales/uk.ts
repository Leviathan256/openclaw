...
export const uk: TranslationMap = {
  ...
  profilePage: {
    ...
    identity: {
      title: "Ідентичність",
      menuLabel: "Меню особи",
      menuButtonLabel: "Меню особи та застосунку для {name}",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "Цей браузер після оновлення потребує одноразового підтвердження пристрою.",
      action: "Захистити цей браузер",
      secureContextRequired:
        "Цей застарілий браузер тимчасово доступний. Відкрийте його знову через HTTPS або localhost, щоб захистити ідентичністю пристрою.",
      pendingUnavailable:
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Гілку потоку змінено — перевірте та надішліть знову.",
    },
    waitingForApproval: "Очікування схвалення…",
    startupStatus: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Діяти в цій темі можуть лише власник і учасники теми.",
    },
    sessionSuggestions: {
      suggest: "Запропонувати",
