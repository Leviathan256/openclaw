...
export const ja_JP: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "中央揃えのトランスクリプト用の任意の CSS 幅（例: 960px、82%、min(1280px, 82%)）。",
      messageWidthInvalid:
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      intro: "この Gateway 上でローカルモデルをダウンロードまたは準備します。",
      button: "モデルをセットアップ / ダウンロード",
      ollamaLabel: "Ollama",
      ollamaHint: "Ollama サーバーからツール対応モデルをダウンロード",
      llamaCppLabel: "ローカルモデル (llama.cpp)",
      llamaCppHint: "約 5.0 GB のローカルモデルをダウンロード。16 GB の RAM が必要です",
    },
    manual: {
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "このブラウザは更新後に一度だけデバイスの承認が必要です。",
      action: "このブラウザを保護",
      secureContextRequired:
        "このレガシーブラウザは一時的に利用可能です。HTTPS または localhost で開き直してデバイスIDで保護してください。",
      pendingUnavailable:
        "ブラウザのペアリングリクエストはまだ利用できません。少し待ってから再試行してください。",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "スレッドがブランチを切り替えました — 確認して再送してください。",
    },
    ...
    composer: {
      ...
      offlineQueuedHint:
        "オフライン — {count}件がキューにあります。接続が回復するとメッセージが送信されます。",
