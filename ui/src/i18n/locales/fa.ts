...
export const fa: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint: "عرض CSS اختیاری برای رونوشت مرکزی، مانند 960px، 82% یا min(1280px, 82%).",
      messageWidthInvalid:
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaLabel: "Ollama",
      ollamaHint: "یک مدل با قابلیت ابزار از سرور Ollama خود دانلود کنید",
      llamaCppLabel: "مدل محلی (llama.cpp)",
      llamaCppHint: "یک مدل محلی حدود ۵.۰ گیگابایتی دانلود کنید؛ به ۱۶ گیگابایت RAM نیاز دارد",
    },
    manual: {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "این مرورگر قدیمی به‌طور موقت در دسترس است. آن را روی HTTPS یا localhost باز کنید تا با هویت دستگاه ایمن شود.",
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      current: "پیدایی رشته: {visibility}",
      visibility: "پیدایی",
