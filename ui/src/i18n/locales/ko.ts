...
export const ko: TranslationMap = {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      button: "모델 설정 / 다운로드",
      ollamaLabel: "Ollama",
      ollamaHint: "Ollama 서버에서 도구 지원 모델을 다운로드합니다",
      llamaCppLabel: "로컬 모델 (llama.cpp)",
      llamaCppHint: "약 5.0GB의 로컬 모델을 다운로드합니다. 16GB RAM이 필요합니다",
    },
    manual: {
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "스레드가 브랜치를 전환했습니다 — 확인 후 다시 보내세요.",
    },
    waitingForApproval: "승인 대기 중…",
    startupStatus: {
