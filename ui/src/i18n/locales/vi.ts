...
export const vi: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "Ẩn danh",
    incognitoDescription: "Chỉ giữ chuỗi này cho đến khi Gateway khởi động lại",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaLabel: "Ollama",
      ollamaHint: "Tải xuống mô hình hỗ trợ công cụ từ máy chủ Ollama của bạn",
      llamaCppLabel: "Mô hình cục bộ (llama.cpp)",
      llamaCppHint: "Tải xuống mô hình cục bộ khoảng 5.0 GB; yêu cầu 16 GB RAM",
    },
    manual: {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Trình duyệt cũ này vẫn khả dụng tạm thời. Hãy mở lại qua HTTPS hoặc localhost để bảo mật bằng danh tính thiết bị.",
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Chỉ chủ sở hữu chủ đề và thành viên mới có thể thao tác trong chủ đề này.",
    },
    sessionSuggestions: {
      suggest: "Đề xuất",
